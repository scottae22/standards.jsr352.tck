...
@javax.inject.Named("countWriter")
public class countWriter extends AbstractItemWriter {

	private final static Logger logger = Logger.getLogger(countWriter.class.getName());
	...
	public void writeItems(List<Object> myData) throws Exception {
		...
		jobCtx.setExitStatus("CHUNK COUNT="+chunkCount);
	}
